...
def explain_zero_trust():
    """Giải thích Zero Trust Architecture"""
    st.markdown("### 🚫 Zero Trust Architecture")
    
    with st.expander("📖 Lý thuyết chi tiết về Zero Trust"):
        st.markdown("""
        ### 🎯 What is Zero Trust?
        ...
        **Traditional Security Model:**
        - **Perimeter-based**: Trust inside, distrust outside
        - **Castle and Moat**: Strong perimeter, weak internal controls
        - **VPN Access**: Once inside, broad access
        - **Static Policies**: Set-and-forget configurations
        
        **Zero Trust Model:**
        - **Identity-centric**: Trust based on identity verification
        - **Micro-segmentation**: Granular access controls
        - **Continuous Verification**: Real-time risk assessment
        - **Dynamic Policies**: Adaptive security controls
        ...
        **1. Identity and Access Management (IAM)**
        ...
        - **Privileged Access Management (PAM)**: Admin account controls
        - **Identity Governance**: Lifecycle management
        
        **2. Device Security**
        - **Device Registration**: Known device inventory
        - **Compliance Checking**: Security posture validation
        - **Mobile Device Management (MDM)**: Mobile security controls
        ...
        **3. Network Security**
        ...
        - **Network Access Control (NAC)**: Device admission control
        - **Encrypted Communications**: End-to-end encryption
        
        **4. Application Security**
        - **Application-level Controls**: Granular permissions
        - **API Security**: Secure application interfaces
        - **Web Application Firewall (WAF)**: Application protection
        ...
        **5. Data Security**
        ...
        - **Rights Management**: Dynamic access controls
        ...
        **Level 2: Advanced (Enhanced Controls)**
        ...
        **Phase 1: Assessment and Planning**
        - **Asset Discovery**: Inventory all resources
        - **Risk Assessment**: Identify critical assets
        - **Gap Analysis**: Current vs desired state
        - **Roadmap Development**: Implementation plan
        
        **Phase 2: Identity and Access**
        - **IAM Implementation**: Centralized identity management
        - **MFA Deployment**: Multi-factor authentication
        - **Privilege Management**: Admin account controls
        - **Policy Development**: Access control policies
        
        **Phase 3: Network and Device**
        - **Network Segmentation**: Micro-segmentation implementation
        - **Device Management**: Endpoint security controls
        - **Monitoring Tools**: Security information and event management
        - **Automation**: Orchestrated security responses
        
        **Phase 4: Applications and Data**
        - **Application Security**: Secure development practices
        - **Data Protection**: Classification and encryption
        - **API Security**: Secure interfaces
        ...
        **Benefits:**
        ...
        - **Remote Work Support**: Secure anywhere access
        
        **Challenges:**
        - **Complexity**: Sophisticated implementation
        - **Cost**: Significant investment required
        - **User Experience**: Potential friction
        - **Cultural Change**: Shift in security mindset
        """)
    
    # Zero Trust components visualization
    st.markdown("#### 🏗️ Zero Trust Architecture Components")
    
    zt_components = [
        {"Component": "Identity Verification", "Traditional": "Perimeter-based", "Zero Trust": "Continuous verification", "Maturity": "Critical"},
        {"Component": "Device Trust", "Traditional": "Domain-joined", "Zero Trust": "Device compliance", "Maturity": "High"},
        {"Component": "Network Access", "Traditional": "VPN tunnel", "Zero Trust": "Micro-segmentation", "Maturity": "High"},
        {"Component": "Application Access", "Traditional": "Network-based", "Zero Trust": "Identity-based", "Maturity": "Medium"},
        {"Component": "Data Protection", "Traditional": "Perimeter controls", "Zero Trust": "Data-centric", "Maturity": "Critical"}
    ]
    
    df = pd.DataFrame(zt_components)
    st.dataframe(df, width='stretch')
